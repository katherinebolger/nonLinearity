...
to infect-students
  let infectedCount 0
  set infectedCount number-infected
  repeat infectedCount [
    repeat Each-Person-Infects [
...
388
635
Number of Infected Students over Time
Day
Infected Students
0.0
100.0
...
"" ""
PENS
"default" 1.0 0 -2674135 true "" "plot number-infected"

@#$#@#$#@
## WHAT IS IT?

This is a model to show behavior if a virus infected people at a fixed daily rate.

## HOW IT WORKS

Each day (tick), a fixed number of people is infected, until the whole population is ill :-(

## HOW TO USE IT

Reset Scenario: resets all variables and the image
Run Model: runs the model until stopped (by clicking the Run Model button again) OR everyone has been infected.

## THINGS TO NOTICE

Infected people move to the bottom of the screen :-)

## THINGS TO TRY

Increase the number of students (up to 250).
...
Katherine Bolger wrote this model in the spring of 2021 for BB&A at Teachers College.
@#$#@#$#@
default
true
0
